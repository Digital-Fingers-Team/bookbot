    ...
    <header className="border-b border-line/80 bg-paper/90 backdrop-blur dark:border-white/10 dark:bg-ink/90">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <Link href="/" className="flex min-w-0 items-center gap-3">
          <span className="inline-flex h-10 w-10 items-center justify-center rounded-md bg-moss text-white shadow-sm shadow-moss/20">
            <BookOpenText className="h-5 w-5" />
          </span>
          <span className="min-w-0">
            <span className="block truncate text-sm font-semibold text-ink dark:text-white">BookBot</span>
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  active
                    ? "bg-moss text-white shadow-sm shadow-moss/15 dark:bg-white dark:text-ink"
